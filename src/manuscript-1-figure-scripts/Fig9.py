...
SUPER_TITLE = "Test-Retest Reliability of PixelDOPA Game Gaze Response Times"
SUPTITLE_Y = .95
...
def create_test_retest_figure_with_outlier_exclusion(manager: GameDataManager, output_dir: Path, config: Dict[str, Any]) -> None:
    ...
    fig.text(0.5, BOTTOM_XLABEL_Y, "Session 1 Mean gRT (s)", ha='center', va='center', fontsize=AXIS_LABEL_FONT_SIZE)
    fig.text(LEFT_YLABEL_X, 0.5, "Session 2 Mean gRT (s)", ha='center', va='center', rotation='vertical', fontsize=AXIS_LABEL_FONT_SIZE)
...
def main():
    ...
    test_retest_dir = project_root / 'manuscript-1-figures' / 'Fig9'
