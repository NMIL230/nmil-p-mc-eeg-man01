...
SUPER_TITLE = "Paired Response Times for NIH Toolbox Tasks vs PixelDOPA Games"  # Overall figure title
...
def create_1x3_scatterplot_rt_pairs(
    ...
    for idx, (nih_task, mc_task) in enumerate(zip(nih_tasks, mc_tasks)):
        ...
        y_label = f"{task_label_map.get(mc_task, mc_task)} RT"
...
def main():
    ...
    final_plots_dir = project_root / "manuscript-1-figures" / "Fig6"
